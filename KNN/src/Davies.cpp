...
void Davies::qfc(double* lb1, double* nc1, int* n1, int* r1, double* sigma, double* c1, int* lim1, double* acc, double* trace, int* ifault, double* res)
{
...
double Davies::exp1(double x)
{
	return x < -50.0 ? 0.0 : std::exp(x);
}

void Davies::counter(void)
{
...
double Davies::log1(double x, BOOL first)
{
	if (fabs(x) > 0.1)
	{
...
void Davies::integrate(int nterm, double interv, double tausq, BOOL mainx)
{
